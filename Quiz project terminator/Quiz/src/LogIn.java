...
public class LogIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("Cushing Hv BT", 0, 36)); // NOI18N
        jLabel2.setText("QUIZ TIME");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 20, 210, -1));
        jLabel2.getAccessibleContext().setAccessibleParent(this);

        jLabel3.setBackground(new java.awt.Color(0, 0, 0));
        jLabel3.setFont(new java.awt.Font("ChuckWarren", 0, 24)); // NOI18N
        ...
        jLabel4.setFont(new java.awt.Font("Cushing Hv BT", 0, 24)); // NOI18N
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Password");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 220, 130, -1));
        ...
        jLabel5.setFont(new java.awt.Font("Cushing Hv BT", 0, 24)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("LogIn ID");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 180, 120, -1));
        ...
        regLBL.setBackground(new java.awt.Color(153, 153, 0));
        regLBL.setFont(new java.awt.Font("Cushing Hv BT", 1, 24)); // NOI18N
        ...
        getContentPane().add(regLBL, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 320, 510, -1));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, -60, 520, 380));
    ...
    private void loginBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBTNActionPerformed
        ...
        } catch (ClassNotFoundException e) { InvalidLBL.setText("Incorrect ID or Password");} catch (SQLException e) {
            InvalidLBL.setText("Incorrect ID or Password");
        }
